...
<div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
    ...
    @endif
    <form class="form-card" action="/interviews/store" method="POST" enctype="multipart/form-data">
            @csrf
...
<div class="form-group">
  <input  name="name" placeholder="interview Name" value="{{ old('name') }}" 
...
<div class="form-group">
  <input  name="name_ar" value="{{ old('name_ar') }}"  placeholder="interview Arabic Name" class="col-md-4 form-control input-md mx-3" style="font-size:15px;"  required type="text">
 </div>
 </div>
 </div>
 <div class="row my-5">
...
<div class="form-group">
  <input  name="desc"  value="{{ old('desc') }}"  placeholder="interview description" class="col-md-4 form-control input-md mx-3" style="font-size:15px;"  required type="text">
 </div>
 </div>
...
<div class="form-group">
  <input  name="desc_ar" value="{{ old('desc_ar') }}"  placeholder="interview Arabic description" class="col-md-4 form-control input-md mx-3" style="font-size:15px;"  required type="text">
 </div>
 </div>
 </div>
<div class="row">
...
<div class="form-group" style="">
  ...
  <div class="" style="">
  <textarea name="interview" id="mytextarea" cols="20" rows="10"> hello world</textarea>
  </div>
</div>
...
<div class="form-group" >
  ...
  <div class="" >
  <textarea name="interview_ar" id="mytextarea_ar" cols="30" rows="10"> مرحبا ..لاضافه العربي</textarea>
  </div>
  </div>
  </div>
<div class="form-group">
    ...
    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-5 m-5">
<div class="form-group">
  <input  name="interviewer" value="{{ old('interviewer') }}" placeholder="interview interviewer" class="col-md-4 form-control input-md mx-3" style="font-size:15px;"  required type="text">
 </div>
 </div>

 <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-5 m-5">
<div class="form-group">
  <input  name="interviewer_ar" value="{{ old('interviewer_ar') }}" placeholder="interview Arabic interviewer" class="col-md-4 form-control input-md mx-3" style="font-size:15px;"  required type="text">
 </div>
 </div>
 </div>
...
<div class="form-group">
  <input  name="voice"  value="{{ old('voice') }}" placeholder="interview voice" class="col-md-4 form-control input-md mx-3" style="font-size:15px;"  required type="text">
 </div>
 </div>
 </div>
