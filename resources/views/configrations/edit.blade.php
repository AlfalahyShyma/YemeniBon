...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    ...
    <form action="/admin/configrations/update/{{$configration->id}}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="image-upload-one">
              <div class="center">
                <div class="form-input">
                  <label for="file-ip-1">
                    <img id="file-ip-1-preview" src="{{ asset('images/'.$configration->icon) }}">
...
<input  name="socialmedia" placeholder="facebook link" value="{{$configration->socialmedia }}" class="col-md-4 form-control input-md mx-3" style="font-size:15px;"  required type="text">
 </div>
 </div> 
